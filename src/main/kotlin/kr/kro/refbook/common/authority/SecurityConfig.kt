        ...
        http
            ...
            .authorizeHttpRequests {
                it
                    ...
                    .requestMatchers("/api/user", "/api/user/info", "/api/products/isbn/{isbn}", "/api/orders/{id}", "/api/orders/orderNumber/{orderNumber}", "/api/categories/{id}").hasAnyRole("MEMBER", "ADMIN")
                    ...
                    .requestMatchers("/api/user/admin/{id}", "/api/user/admin", "/api/orders").hasRole("ADMIN")
